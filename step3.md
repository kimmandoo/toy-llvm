...
좀만 더 Value*에 대해 깊게 들어가보면, LLVM IR 객체는 보통 Module, Function, BasicBlock, LLVMContext 같은 상위 객체가 소유하는데, IRBuilder는 새 instruction을 만들고 그 instruction을 현재 block에 삽입한다.
